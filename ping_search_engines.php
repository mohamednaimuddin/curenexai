...
$urlsToSubmit = [
    "https://{$host}/",
    "https://{$host}/about",
    "https://{$host}/authors/dr-aysha-shirin",
    "https://{$host}/digital-repertory-software-homeopathy",
    "https://{$host}/radaropus-alternative",
    "https://{$host}/vs-radaropus",
    "https://{$host}/best-homeopathy-software",
    "https://{$host}/ai-homeopathy-software",
    "https://{$host}/cloud-homeopathy-software",
    "https://{$host}/homeopathy-repertory-software",
    "https://{$host}/register",
    "https://{$host}/login",
    "https://{$host}/privacy",
    "https://{$host}/terms",
